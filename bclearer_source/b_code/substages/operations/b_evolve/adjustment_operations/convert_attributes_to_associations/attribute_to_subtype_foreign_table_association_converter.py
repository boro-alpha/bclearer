...
from bclearer_source.b_code.substages.operations.b_evolve.adjustment_operations.convert_attributes_to_associations.generalisation_from_attribute_creator import create_generalisation_from_attribute_to_type
